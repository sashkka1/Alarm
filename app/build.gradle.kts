...
//
//   productVersion — версия из карты версий в CLAUDE.md (v1..v8). ЕДИНСТВЕННОЕ,
//                    что правится руками, при переходе на следующую версию.
...
if (bumpRequested) {
    versionFile.writeText(
        buildString {
            appendLine("# Версия продукта из карты версий в CLAUDE.md (v1..v8).")
            appendLine("# ЕДИНСТВЕННОЕ, что правится руками — при переходе на следующую версию.")
