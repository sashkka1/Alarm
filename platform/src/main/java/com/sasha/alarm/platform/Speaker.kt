...
class Speaker(context: Context) {
    ...
    private companion object {
        ...
        /**
         * Насколько медленнее обычного говорит движок.
         *
         * Обычная скорость синтеза рассчитана на человека, который слушает
         * внимательно. Под нагрузкой, лицом в пол, владелец её не разбирал
         * (2026-08-18: «слишком быстро говорит команды, не понятно что делать»).
         */
